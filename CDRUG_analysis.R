...
xt4 <- as.data.frame(xt3)
WriteXLS::WriteXLS(x="xt4", ExcelFileName=file.path(saveres, "correlations_ic50_pvalue_paper.xls"), row.names=TRUE)
...
xt4 <- as.data.frame(xt3)
WriteXLS::WriteXLS(x="xt4", ExcelFileName=file.path(saveres, "correlations_auc_pvalue_paper.xls"), row.names=TRUE)
